...
rem This enables B.O.D at 1.8v and sets the clock source to external 16Mhz xtal
@avrdude -C avrdude.conf -pattiny841 -cusbtiny -e -Uefuse:w:0b11111110:m -Uhfuse:w:0b11011110:m -Ulfuse:w:0xEE:m 
...
@avrdude -C avrdude.conf -pattiny841 -cusbtiny -e -Uflash:w:Qwiic_Fan_Controller.ino.hex:i
